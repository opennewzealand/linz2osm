...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WorksliceFeature', fields ['feature_id']
        db.create_index('workslices_workslicefeature', ['feature_id'])

        # Adding index on 'Workslice', fields ['checked_out_at']
        db.create_index('workslices_workslice', ['checked_out_at'])


    def backwards(self, orm):
        # Removing index on 'Workslice', fields ['checked_out_at']
        db.delete_index('workslices_workslice', ['checked_out_at'])

        # Removing index on 'WorksliceFeature', fields ['feature_id']
        db.delete_index('workslices_workslicefeature', ['feature_id'])
