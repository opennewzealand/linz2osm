...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WorksliceFeature', fields ['workslice']
        db.create_index('workslices_workslicefeature', ['workslice_id', 'feature_id'])


    def backwards(self, orm):
        # Removing index on 'WorksliceFeature', fields ['workslice']
        db.delete_index('workslices_workslicefeature', ['workslice_id', 'feature_id'])
