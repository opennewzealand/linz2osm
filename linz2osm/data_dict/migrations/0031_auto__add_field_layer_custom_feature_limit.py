...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.custom_feature_limit'
        db.add_column(u'data_dict_layer', 'custom_feature_limit',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.custom_feature_limit'
        db.delete_column(u'data_dict_layer', 'custom_feature_limit')
    ...
    models = {
        ...
        u'data_dict.layer': {
            ...
            'custom_feature_limit': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
