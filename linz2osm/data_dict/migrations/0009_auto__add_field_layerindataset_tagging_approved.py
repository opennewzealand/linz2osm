...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LayerInDataset.tagging_approved'
        db.add_column('data_dict_layerindataset', 'tagging_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LayerInDataset.tagging_approved'
        db.delete_column('data_dict_layerindataset', 'tagging_approved')
