...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.pkey_name'
        db.add_column('data_dict_layer', 'pkey_name',
                      self.gf('django.db.models.fields.CharField')(default='ogc_fid', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.pkey_name'
        db.delete_column('data_dict_layer', 'pkey_name')
