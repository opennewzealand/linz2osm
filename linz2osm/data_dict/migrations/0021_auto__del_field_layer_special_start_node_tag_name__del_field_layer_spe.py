...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Layer.special_start_node_tag_name'
        db.delete_column('data_dict_layer', 'special_start_node_tag_name')

        # Deleting field 'Layer.special_end_node_tag_name'
        db.delete_column('data_dict_layer', 'special_end_node_tag_name')

        # Adding field 'Layer.special_node_tag_name'
        db.add_column('data_dict_layer', 'special_node_tag_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Layer.special_start_node_tag_name'
        db.add_column('data_dict_layer', 'special_start_node_tag_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Layer.special_end_node_tag_name'
        db.add_column('data_dict_layer', 'special_end_node_tag_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Layer.special_node_tag_name'
        db.delete_column('data_dict_layer', 'special_node_tag_name')
