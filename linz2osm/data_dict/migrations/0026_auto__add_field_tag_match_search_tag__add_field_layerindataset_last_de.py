...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.match_search_tag'
        db.add_column('data_dict_tag', 'match_search_tag',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'LayerInDataset.last_deletions_dump_filename'
        db.add_column('data_dict_layerindataset', 'last_deletions_dump_filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.match_search_tag'
        db.delete_column('data_dict_tag', 'match_search_tag')

        # Deleting field 'LayerInDataset.last_deletions_dump_filename'
        db.delete_column('data_dict_layerindataset', 'last_deletions_dump_filename')
