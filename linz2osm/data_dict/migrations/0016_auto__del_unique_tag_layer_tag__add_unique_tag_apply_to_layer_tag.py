...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Tag', fields ['apply_to', 'layer', 'tag']
        db.create_unique('data_dict_tag', ['apply_to', 'layer_id', 'tag'])


    def backwards(self, orm):
        # Removing unique constraint on 'Tag', fields ['apply_to', 'layer', 'tag']
        db.delete_unique('data_dict_tag', ['apply_to', 'layer_id', 'tag'])
