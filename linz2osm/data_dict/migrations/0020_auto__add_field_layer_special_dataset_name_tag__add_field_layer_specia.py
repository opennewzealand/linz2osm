...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.special_dataset_name_tag'
        db.add_column('data_dict_layer', 'special_dataset_name_tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Layer.special_dataset_version_tag'
        db.add_column('data_dict_layer', 'special_dataset_version_tag',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.special_dataset_name_tag'
        db.delete_column('data_dict_layer', 'special_dataset_name_tag')

        # Deleting field 'Layer.special_dataset_version_tag'
        db.delete_column('data_dict_layer', 'special_dataset_version_tag')
