...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dataset.generating_deletions_osm'
        db.add_column('data_dict_dataset', 'generating_deletions_osm',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dataset.generating_deletions_osm'
        db.delete_column('data_dict_dataset', 'generating_deletions_osm')
