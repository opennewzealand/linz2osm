...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dataset.update_method'
        db.add_column('data_dict_dataset', 'update_method',
                      self.gf('django.db.models.fields.CharField')(default='manual', max_length=255),
                      keep_default=False)

        # Adding field 'Layer.wfs_type_name'
        db.add_column('data_dict_layer', 'wfs_type_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Layer.wfs_cql_filter'
        db.add_column('data_dict_layer', 'wfs_cql_filter',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dataset.update_method'
        db.delete_column('data_dict_dataset', 'update_method')

        # Deleting field 'Layer.wfs_type_name'
        db.delete_column('data_dict_layer', 'wfs_type_name')

        # Deleting field 'Layer.wfs_cql_filter'
        db.delete_column('data_dict_layer', 'wfs_cql_filter')
