...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatasetUpdate.error'
        db.add_column('data_dict_datasetupdate', 'error',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatasetUpdate.error'
        db.delete_column('data_dict_datasetupdate', 'error')
