...
class Layer(models.Model):
    ...
    special_node_tag_name = geomodels.CharField(max_length=255, blank=True)
    special_dataset_name_tag = geomodels.CharField(max_length=255, blank=True)
    special_dataset_version_tag = geomodels.CharField(max_length=255, blank=True)
